local log_path = "/tmp/safari-gauntlet-clerk-green.log"
local screenshot_path = "/tmp/safari-gauntlet-clerk-green.png"
...
cbid = callbacks:add("frame", function()
	...
	elseif phase == "talk" then
		...
		elseif phase_frame == 190 then
			...
			state_line("VERIFIED_GREEN_CLERK")
			apply_keys(0)
			callbacks:remove(cbid)
			return
		end
...
log("Safari Gauntlet green clerk verifier loaded")
state_line("initial")
