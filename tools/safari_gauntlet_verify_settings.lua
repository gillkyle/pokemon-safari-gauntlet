local log_path = "/tmp/safari-gauntlet-settings.log"
local screenshot_path = "/tmp/safari-gauntlet-settings.png"
...
log("Safari Gauntlet settings verifier loaded")
state_line("initial")
