local log_path = "/tmp/safari-gauntlet-keepbox.log"
local screenshot_path = "/tmp/safari-gauntlet-keepbox-only.png"
...
log("Safari Gauntlet keepbox verifier loaded")
state_line("initial")
