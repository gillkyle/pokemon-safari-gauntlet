...
BattleMusic_Legendaries:
	music_legendary ARTICUNO, PLAIN_FORM,    MUSIC_KANTO_LEGEND_BATTLE_XY
	music_legendary ARTICUNO, GALARIAN_FORM, MUSIC_KANTO_LEGEND_BATTLE_XY
	music_legendary ZAPDOS,   PLAIN_FORM,    MUSIC_KANTO_LEGEND_BATTLE_XY
	music_legendary ZAPDOS,   GALARIAN_FORM, MUSIC_KANTO_LEGEND_BATTLE_XY
	music_legendary MOLTRES,  PLAIN_FORM,    MUSIC_KANTO_LEGEND_BATTLE_XY
