...
The current Safari Gauntlet release target is **v1.0.3**.
...
```text
build/safari-gauntlet-1.0.3.gbc
build/safari-gauntlet-1.0.3.sym
build/safari-gauntlet-1.0.3.bps
build/safari-gauntlet-1.0.3.ips
build/safari-gauntlet-1.0.3.3ds-vc.patch
```
